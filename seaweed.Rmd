...
phylum <- subset_samples(ps, Response != "response" & TimepointCat == "during") %>% collapse("Phylum")
...
```{r}
genera <- subset_samples(ps, Response != "responder" & TimepointCat == "during") %>% collapse("Genus")
